...
<model ref="r:f3490366-03f3-47c2-9f80-cf5321b5ddc0(com.github.fxlex.js.BackboneJS.behavior)">
  ...
  <imports>
    ...
    <import index="ygo0" ref="r:8460575b-e0b7-43ea-af31-76206e2d2071(com.github.fxlex.js.BackboneJS.structure)" implicit="true" />
  </imports>
  <registry>
  ...
  <node concept="13h7C7" id="3xe3kbTFtE5">
    <ref role="13h7C2" to="ygo0:6jNo51xcyqe" resolve="BackboneJsDependency" />
                ...
                <node concept="2pNNFK" id="4AfnAIOjyID" role="2c44tc">
                  ...
                  <node concept="2pNNFK" id="4AfnAIOjyIN" role="3o6s8t">
                    ...
                    <node concept="3o6iSG" id="4AfnAIOjyIR" role="3o6s8t">
                      <property role="3o6i5n" value="backbone" />
                    </node>
                  </node>
          ...
          <node concept="2OqwBi" id="4dtLQgJeqoQ" role="3clFbG">
            ...
            <node concept="TSZUe" id="4dtLQgJeqEc" role="2OqNvi">
              <node concept="Xl_RD" id="4dtLQgJe_tq" role="25WWJ7">
                <property role="Xl_RC" value="http://cdnjs.cloudflare.com/ajax/libs/backbone.js/0.9.2/backbone-min.js" />
              </node>
            </node>
          </node>
        </node>
