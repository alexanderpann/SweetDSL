...
<model ref="r:0e309ffc-8a60-4faf-8092-4ec3efc297a5(com.github.fxlex.js.Marked.behavior)">
  ...
  <imports>
    ...
    <import index="kcph" ref="r:9b2a5a6c-8719-4f9f-8cfc-0294da3ffe32(com.github.fxlex.js.Marked.structure)" implicit="true" />
  </imports>
  <registry>
  ...
  <node concept="13h7C7" id="3xe3kbTFtE5">
    <ref role="13h7C2" to="kcph:6jNo51xcyqe" resolve="MarkedJSDependency" />
                ...
                <node concept="2pNNFK" id="4AfnAIOjyID" role="2c44tc">
                  ...
                  <node concept="2pNNFK" id="4AfnAIOjyIN" role="3o6s8t">
                    ...
                    <node concept="3o6iSG" id="4AfnAIOjyIR" role="3o6s8t">
                      <property role="3o6i5n" value="marked" />
                    </node>
                  </node>
          ...
          <node concept="2OqwBi" id="4dtLQgJeqoQ" role="3clFbG">
            ...
            <node concept="TSZUe" id="4dtLQgJeqEc" role="2OqNvi">
              <node concept="Xl_RD" id="4dtLQgJe_tq" role="25WWJ7">
                <property role="Xl_RC" value="https://cdnjs.cloudflare.com/ajax/libs/marked/0.3.5/marked.js" />
              </node>
            </node>
          </node>
        </node>
